...
- 프로덕션: <https://scorelink.pages.dev>
...
배포마다 고유 미리보기 URL이 발급되고, 브랜치별 alias URL도 함께 생성된다.

| 대상 | URL 예시 |
|------|----------|
| 프로덕션(기본 브랜치) | `https://scorelink.pages.dev` |
| 개별 배포(고유 해시) | `https://<hash>.scorelink.pages.dev` |
| 브랜치 alias | `https://<branch>.scorelink.pages.dev` (예: `feat-community`) |
